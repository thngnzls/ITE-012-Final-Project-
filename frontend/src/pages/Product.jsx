              ...
              <table className="w-full text-sm border">
                <thead>
                  <tr>
                    ...
                    <th className="border p-2">Bust (Inch)</th>
                    <th className="border p-2">Waist (Inch)</th>
                    <th className="border p-2">Hip (Inch)</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
            ...
            <div className="mb-4">
              ...
              <table className="w-full text-sm border">
                <thead>
                  <tr>
                    <th className="border p-2">Size</th>
                    <th className="border p-2">1/2 Chest (cm)</th>
                    <th className="border p-2">Front Length (cm)</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
